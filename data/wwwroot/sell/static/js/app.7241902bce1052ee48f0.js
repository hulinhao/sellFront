webpackJsonp([2, 0], [function(t, e, s) {
		...
		methods: {
			show: function() {
				...
				this.showFlag = !0, this.selectType = _, this.onlyContent = !0, this.$nextTick(function() {
					t.scroll ? t.scroll.refresh() : t.scroll = new n.default(t.$refs.food, {
						click: !0
					})
				})
			},
	...
	e.default = {
				...
				e = e.body, e.code === h && (s.map(function(t) {
					e.data.map(function(s, a) {
						s.foods.map(function(i, n) {
							i.id === t.id && (s.foods.splice(n, 1, (0, r.default)(s.foods[n], {
								count: t.count
							})), e.data.splice(a, 1, s))
						})
					})
		...
		methods: {
			...
			_initScroll: function() {
				var t = this;
				this.meunScroll = new l.default(this.$refs.menuWrapper, {
					click: !0
				}), this.foodsScroll = new l.default(this.$refs.foodsWrapper, {
					click: !0,
					probeType: 3
		...
		created: function() {
			...
			this.$http.get("/sell/api/ratings.json").then(function(e) {
				e = e.body, e.errno === f && (t.ratings = e.data, t.$nextTick(function() {
					t.scroll = new n.default(t.$refs.ratings, {
						click: !0
					})
				}))
			})
	...
	e.default = {
		...
		methods: {
			...
			_initScroll: function() {
				this.scroll ? this.scroll.refresh() : this.scroll = new n.default(this.$refs.seller, {
					click: !0
				})
			},
			_initPics: function() {
				...
				if (this.seller.pics) {
					var e = 120,
						s = 6,
						a = (e + s) * this.seller.pics.length - s;
		...
		computed: {
			...
			listShow: function() {
				...
				return e && this.$nextTick(function() {
					t.scroll ? t.scroll.refresh() : t.scroll = new o.default(t.$refs.listContent, {
						click: !0
					})
				}), e
			}
...
}, , , , , , , , , , , , , , , , , , , , , , , , , , , , , function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, , , , , , , , , , , , , , , , , , , , , function(t, e, s) {
	s(87);
	...
	t.exports = {
		render: function() {
			...
			return s("div", {
				...
				staticClass: "name"
			}, [t._v(t._s(t.seller.name))])]), t._v(" "), s("div", {
				staticClass: "description"
			}, [t._v("\n        " + t._s(t.seller.description) + "/" + t._s(t.seller.deliveryTime) + "分钟送达\n      ")]), t._v(" "), t.seller.supports ? s("div", {
				staticClass: "support"
			}, [s("span", {
				staticClass: "icon",
				...
				staticClass: "text"
			}, [t._v(t._s(t.seller.supports[0].description))])]) : t._e()]), t._v(" "), t.seller.supports ? s("div", {
				...
				staticClass: "count"
			}, [t._v(t._s(t.seller.supports.length) + "个")]), t._v(" "), s("i", {
			...
			}, [t._v(t._s(t.seller.bulletin))]), t._v(" "), s("i", {
				staticClass: "icon-keyboard_arrow_right"
			})]), t._v(" "), s("div", {
				...
				staticClass: "text"
			}, [t._v("优惠信息")]), t._v(" "), s("div", {
				staticClass: "line"
			})]), t._v(" "), t.seller.supports ? s("ul", {
				staticClass: "supports"
			}, t._l(t.seller.supports, function(e, a) {
				return s("li", {
					...
					staticClass: "text"
				}, [t._v(t._s(t.seller.supports[a].description))])])
			})) : t._e(), t._v(" "), s("div", {
				staticClass: "title"
			}, [s("div", {
				staticClass: "line"
				...
				staticClass: "text"
			}, [t._v("商家公告")]), t._v(" "), s("div", {
				staticClass: "line"
			})]), t._v(" "), s("div", {
				staticClass: "bulletin"
			}, [s("p", {
				staticClass: "content"
			}, [t._v(t._s(t.seller.bulletin))])])])]), t._v(" "), s("div", {
	...
	t.exports = {
		render: function() {
			...
			return s("div", {
				...
				staticClass: "text"
			}, [t._v("(" + t._s(t.seller.ratingCount) + ")")]), t._v(" "), s("span", {
				staticClass: "text"
			}, [t._v("月售" + t._s(t.seller.sellCount) + "单")])], 1), t._v(" "), s("ul", {
				staticClass: "remark"
			}, [s("li", {
				staticClass: "block"
			}, [s("h2", [t._v("起送价")]), t._v(" "), s("div", {
				staticClass: "content"
			}, [s("span", {
				staticClass: "stress"
			}, [t._v(t._s(t.seller.minPrice))]), t._v("元\n          ")])]), t._v(" "), s("li", {
				staticClass: "block"
			}, [s("h2", [t._v("商家配送")]), t._v(" "), s("div", {
				staticClass: "content"
			}, [s("span", {
				staticClass: "stress"
			}, [t._v(t._s(t.seller.deliveryPrice))]), t._v("元\n          ")])]), t._v(" "), s("li", {
				staticClass: "block"
			}, [s("h2", [t._v("平均配送时间")]), t._v(" "), s("div", {
				staticClass: "content"
			}, [s("span", {
				staticClass: "stress"
			}, [t._v(t._s(t.seller.deliveryTime))]), t._v("分钟\n          ")])])]), t._v(" "), s("div", {
				...
				staticClass: "text"
			}, [t._v(t._s(t.favoriteText))])])]), t._v(" "), s("split"), t._v(" "), s("div", {
				staticClass: "bulletin"
			}, [s("h1", {
				staticClass: "title"
			}, [t._v("公告与活动")]), t._v(" "), s("div", {
				staticClass: "content-wrapper border-1px"
			}, [s("p", {
				staticClass: "content"
			}, [t._v(t._s(t.seller.bulletin))])]), t._v(" "), t.seller.supports ? s("ul", {
				staticClass: "supports"
			}, t._l(t.seller.supports, function(e, a) {
				return s("li", {
			...
			})) : t._e()]), t._v(" "), s("split"), t._v(" "), s("div", {
				staticClass: "pics"
			}, [s("h1", {
				staticClass: "title"
			}, [t._v("商家实景")]), t._v(" "), s("div", {
				ref: "picWrapper",
				staticClass: "pic-wrapper"
			}, [s("ul", {
				ref: "picList",
				staticClass: "pic-list"
			}, t._l(t.seller.pics, function(t) {
				return s("li", {
			...
			}))])]), t._v(" "), s("split"), t._v(" "), s("div", {
				staticClass: "info"
			}, [s("h1", {
				staticClass: "title border-1px"
			}, [t._v("商家信息")]), t._v(" "), s("ul", t._l(t.seller.infos, function(e) {
				return s("li", {
	...
	t.exports = {
		render: function() {
			...
			return s("div", [s("div", {
				...
				staticClass: "price",
				class: {
					highlight: t.totalPrice > 0
				}
			}, [t._v("￥" + t._s(t.totalPrice))]), t._v(" "), s("div", {
				staticClass: "desc"
			}, [t._v("另需配送费￥" + t._s(t.deliveryPrice) + "元")])]), t._v(" "), s("div", {
				...
				return s("li", {
					...
					staticClass: "price"
				}, [s("span", [t._v("￥" + t._s(e.price * e.count))])]), t._v(" "), s("div", {
	...
	t.exports = {
		render: function() {
			...
			return s("div", {
				...
				staticClass: "score"
			}, [t._v(t._s(t.seller.score))]), t._v(" "), s("div", {
				staticClass: "title"
			}, [t._v("综合评分")]), t._v(" "), s("div", {
				staticClass: "rank"
			}, [t._v("高于周边商家" + t._s(t.seller.rankRate) + "%")])]), t._v(" "), s("div", {
				staticClass: "overview-right"
			}, [s("div", {
				staticClass: "score-wrapper"
			}, [s("span", {
				staticClass: "title"
			}, [t._v("服务态度")]), t._v(" "), s("star", {
				attrs: {
					size: 36,
				...
				staticClass: "score"
			}, [t._v(t._s(t.seller.serviceScore))])], 1), t._v(" "), s("div", {
				staticClass: "score-wrapper"
			}, [s("span", {
				staticClass: "title"
			}, [t._v("商品评分")]), t._v(" "), s("star", {
				attrs: {
					size: 36,
				...
				staticClass: "score"
			}, [t._v(t._s(t.seller.foodScore))])], 1), t._v(" "), s("div", {
				staticClass: "delivery-wrapper"
			}, [s("span", {
				staticClass: "title"
			}, [t._v("送达时间")]), t._v(" "), s("span", {
				staticClass: "delivery"
			}, [t._v(t._s(t.seller.deliveryTime) + "分钟")])])])]), t._v(" "), s("split"), t._v(" "), s("ratingselect", {
				attrs: {
				...
				on: {
					select: t.selectRating,
					toggle: t.toggleContent
				}
			}), t._v(" "), s("div", {
				staticClass: "rating-wrapper"
			}, [s("ul", t._l(t.ratings, function(e) {
				return s("li", {
					directives: [{
						name: "show",
						rawName: "v-show",
					...
					staticClass: "name"
				}, [t._v(t._s(e.username))]), t._v(" "), s("div", {
					staticClass: "star-wrapper"
				}, [s("star", {
					attrs: {
						size: 24,
					...
					staticClass: "delivery"
				}, [t._v(t._s(e.deliveryTime))])], 1), t._v(" "), s("p", {
					staticClass: "text"
				}, [t._v(t._s(e.text))]), t._v(" "), s("div", {
					directives: [{
						name: "show",
						rawName: "v-show",
				...
				}), t._v(" "), t._l(e.recommend, function(e) {
					return s("span", {
						staticClass: "item"
					}, [t._v(t._s(e))])
				})], 2), t._v(" "), s("div", {
	...
	t.exports = {
		render: function() {
			...
			return s("div", {
				...
				return s("a", {
					...
					staticClass: "ordercard-body"
				}, [t._m(0, !0), t._v(" "), s("div", {
					staticClass: "ordercard-content"
				}, [s("div", {
					...
					staticClass: "content"
				}, [t._v(t._s(t._f("time")(e.createTime)))]), t._v(" "), s("svg", [s("use", {
					attrs: {
					...
					staticClass: "status"
				}, [t._v(t._s(t._f("formatOrderStatus")(e.orderStatus, e.payStatus)))])])]), t._v(" "), s("div", {
					staticClass: "ordercard-detail"
				}, [s("p", {
					staticClass: "detail"
				}), t._v(" "), s("p", {
					staticClass: "price"
				}, [t._v("¥" + t._s(e.orderAmount))])])])])])
			}))
		},
		staticRenderFns: [function() {
			...
			return s("div", {
				...
				attrs: {
					src: "https://fuss10.elemecdn.com/2/e4/bff50bab2840cdfbffeaf13a20710png.png?imageMogr/format/webp/"
				}
			})])
		}]
	}
	...
	t.exports = {
		render: function() {
			...
			return s("transition", {
				...
				staticClass: "title"
			}, [t._v(t._s(t.food.name))]), t._v(" "), s("div", {
				staticClass: "detail"
			}, [s("span", {
				staticClass: "sell-count"
			}, [t._v("月售" + t._s(t.food.sellCount) + "份")]), t._v(" "), s("span", {
				staticClass: "rating"
			}, [t._v("好评率" + t._s(t.food.rating) + "%")])]), t._v(" "), s("div", {
				staticClass: "price"
			}, [s("span", {
				staticClass: "now"
			}, [t._v("￥" + t._s(t.food.price))]), s("span", {
				directives: [{
					name: "show",
					rawName: "v-show",
				...
				staticClass: "old"
			}, [t._v("￥" + t._s(t.food.oldPrice))])]), t._v(" "), s("div", {
				staticClass: "cartcontrol-wrapper"
			}, [s("cartcontrol", {
				attrs: {
					food: t.food
				...
				staticClass: "text"
			}, [t._v(t._s(t.food.info))])]), t._v(" "), s("split"), t._v(" "), s("div", {
				staticClass: "rating"
			}, [s("h1", {
				staticClass: "title"
			}, [t._v("商品评价")]), t._v(" "), s("ratingselect", {
				attrs: {
					selectType: t.selectType,
					onlyContent: t.onlyContent,
					desc: t.desc,
				...
				return s("li", {
					...
					staticClass: "name"
				}, [t._v(t._s(e.username))]), t._v(" "), s("img", {
					staticClass: "avatar",
					attrs: {
						width: "12",
						height: "12",
					...
					staticClass: "time"
				}, [t._v(t._s(t._f("formatDate")(e.rateTime)))]), t._v(" "), s("p", {
					staticClass: "text"
				}, [s("span", {
					class: {
						"icon-thumb_up": 0 === e.rateType, "icon-thumb_down": 1 === e.rateType
					}
				}), t._v(t._s(e.text) + "\n              ")])])
			})), t._v(" "), s("div", {
				directives: [{
	...
	t.exports = {
		render: function() {
			...
			return s("div", {
				staticClass: "star",
				class: t.starType
			}, t._l(t.itemClasses, function(t, e) {
				return s("span", {
					key: "index",
	...
	t.exports = {
		render: function() {
			...
			return s("div", {
				...
				staticClass: "statushead"
			}, [t._m(0), t._v(" "), s("h1", {
				staticClass: "statustext"
			}, [t._v(" " + t._s(t._f("orderStatusName")(t.order.orderStatus)) + " ")]), t._v(" "), s("div", {
				staticClass: "buttons"
			}, [0 == t.order.orderStatus && 0 == t.order.payStatus ? s("button", {
				on: {
					click: function(e) {
			...
			}, [t._v(t._s(t.cancelOrderName))]) : t._e()])]), t._v(" "), s("div", {
				staticClass: "restaurant-card"
			}, [t._m(1), t._v(" "), s("div", {
				staticClass: "product-list listitem"
			}, t._l(t.orderDetailList, function(e) {
				return s("ul", {
				...
				}, [t._v("x" + t._s(e.productQuantity))]), t._v(" "), s("span", [t._v("¥" + t._s(e.productPrice * e.productQuantity))])])])])
			})), t._v(" "), s("div", {
				staticClass: "finalprice listitem"
			}, [t._v("\n                实付 ¥" + t._s(t.order.orderAmount) + "\n            ")])]), t._v(" "), s("div", {
				staticClass: "detailcard"
			}, [s("div", {
				staticClass: "detailcard-delivery card"
			}, [s("div", {
				staticClass: "title listitem"
			}, [t._v("\n                    配送信息\n                ")]), t._v(" "), s("ul", {
				staticClass: "cardlist"
			}, [t._m(2), t._v(" "), s("li", {
				staticClass: "listitem"
			}, [s("span", [t._v("送货地址：")]), t._v(" "), s("div", {
				staticClass: "content"
			}, [s("p", [t._v(t._s(t.order.buyerName))]), t._v(" "), s("p", [t._v(t._s(t.order.buyerPhone))]), t._v(" "), s("p", [t._v(t._s(t.order.buyerAddress))])])])])]), t._v(" "), s("div", {
				staticClass: "detailcard-order card"
			}, [s("div", {
				staticClass: "title listitem"
			}, [t._v("\n                    订单信息\n                ")]), t._v(" "), s("ul", {
				staticClass: "cardlist"
				...
				staticClass: "listitem"
			}, [s("span", [t._v("订单号：")]), t._v(t._s(t.order.orderId) + " ")]), t._v(" "), s("li", {
				staticClass: "listitem"
			}, [s("span", [t._v("支付方式：")]), t._v(t._s(t._f("payName")(t.order.payType)) + " ")]), t._v(" "), s("li", {
				staticClass: "listitem"
			}, [s("span", [t._v("下单时间：")]), t._v(t._s(t._f("time")(t.order.createTime)) + " ")])])])])])
		},
		staticRenderFns: [function() {
			var t = this,
				e = t.$createElement,
		...
		render: function() {
			...
			return s("div", [s("div", {
				...
				return s("li", {
					...
					staticClass: "title"
				}, [t._v(t._s(e.name))]), t._v(" "), s("ul", t._l(e.foods, function(e) {
					return s("li", {
						...
						staticClass: "desc"
					}, [t._v(t._s(e.description))]), t._v(" "), s("div", {
						staticClass: "extra"
					}, [s("span", {
						staticClass: "count"
					}, [t._v("月售" + t._s(e.sellCount) + "份")]), s("span", [t._v("好评率" + t._s(e.rating) + "%")])]), t._v(" "), s("div", {
						staticClass: "price"
					}, [s("span", {
						staticClass: "now"
						...
						staticClass: "old"
					}, [t._v("￥" + t._s(e.oldPrice))])]), t._v(" "), s("div", {
						staticClass: "cartcontrol-wrapper"
					}, [s("cartcontrol", {
						attrs: {
							food: e
	...
	t.exports = {
		render: function() {
			...
			}, [t._v(t._s(t.desc.all)), s("span", {
				staticClass: "count"
			}, [t._v(t._s(t.ratings.length))])]), t._v(" "), s("span", {
				staticClass: "block positive",
				class: {
					active: 0 === t.selectType
				},
				on: {
					click: function(e) {
						t.select(0, e)
			...
			}, [t._v(t._s(t.desc.positive)), s("span", {
				staticClass: "count"
			}, [t._v(t._s(t.positives.length))])]), t._v(" "), s("span", {
				staticClass: "block negative",
				class: {
					active: 1 === t.selectType
				},
				on: {
					click: function(e) {
						t.select(1, e)
			...
			}, [t._v(t._s(t.desc.negative)), s("span", {
				staticClass: "count"
			}, [t._v(t._s(t.negatives.length))])])]), t._v(" "), s("div", {
				staticClass: "switch",
				class: {
					on: t.onlyContent
				},
	...
	t.exports = {
		render: function() {
			var t = this,
				e = t.$createElement,
				s = t._self._c || e;
			return s("div", [t.showHeader ? [s("v-header", {
				attrs: {
					seller: t.seller
				}
			}), t._v(" "), s("div", {
			...
			}, [t._v("商品")])], 1), t._v(" "), s("div", {
				staticClass: "tab-item"
			}, [s("router-link", {
				attrs: {
					to: "/ratings"
				}
			}, [t._v("评论")])], 1), t._v(" "), s("div", {
				staticClass: "tab-item"
			}, [s("router-link", {
				attrs: {
					to: "/seller"
				}
			}, [t._v("商家")])], 1)])] : t._e(), t._v(" "), s("router-view", {
				attrs: {
					seller: t.seller,
	...
	t.exports = {
		render: function() {
			...
			return s("div", {
				...
				staticClass: "title"
			}, [t._v(t._s(t.seller.name))])]), t._v(" "), t._l(t.selectedGoods, function(e) {
				return s("div", {
					staticClass: "food-item"
				}, [s("label", [t._v(t._s(e.name))]), t._v(" "), s("div", {
					staticClass: "mount"
				}, [e.count > 1 ? s("span", {
					staticClass: "number"
				}, [t._v("x" + t._s(e.count))]) : t._e(), t._v("¥" + t._s(e.count * e.price))])])
			})], 2), t._v(" "), s("div", {
				staticClass: "footer"
			}, [s("div", {
				staticClass: "money"
			}, [t._v("待支付¥" + t._s(this.allPay))]), t._v(" "), s("div", {
				staticClass: "btn-pay",
				on: {
					click: t.pay
				}
